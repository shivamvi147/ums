...
if(isset($_POST['login'])){
  $data = array("username"=>$_POST['username'],"password"=> $_POST['loginpassword']);
  $response = callAPI('POST', 'login.php', $data);
    if($response['httpcode'] == 200 && $response['data']->status == 200){
        $_SESSION['token'] = $response['data']->token;
        $profile = callAPI('GET', 'profile.php');
        if($profile['httpcode'] == 200 && $profile['data']->status == 200){
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="signup.php">Register an user!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
